...
def final_process_data(data_dict):
    ...
    if 'г. Москва' in frame.index:
        frame['Доля рабочих мест в % к среднемосковской, 2016'] = 100*frame['Число рабочих мест в % к численности населения 2016']/frame[
                                                                        'Число рабочих мест в % к численности населения 2016']['г. Москва']
        frame['Доля рабочих мест в % к среднемосковской, 2018'] = 100*frame['Число рабочих мест в % к численности населения 2018']/frame[
                                                                        'Число рабочих мест в % к численности населения 2018']['г. Москва']
        frame['Средняя белая зарплата в % к среднемосковской, 2016'] = 100*frame['Средняя белая зарплата 2016']/frame[
                                                                        'Средняя белая зарплата 2016']['г. Москва']
        frame['Средняя белая зарплата в % к среднемосковской, 2018'] = 100*frame['Средняя белая зарплата 2018']/frame[
                                                                        'Средняя белая зарплата 2018']['г. Москва']
    return frame
